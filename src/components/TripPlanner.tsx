...
import { Loader2, MapPin, Users, Calendar, Heart, Sparkles, Baby, User, Users2, Briefcase, TreePine, History, ShoppingBag, Utensils, Camera, Music, Mountain, Waves } from 'lucide-react';
...
export function TripPlanner({ cityName, cityNameEn, country }: TripPlannerProps) {
